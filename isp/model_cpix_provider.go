...
func (o *CpixProvider) GetCertificatesId() string {
...
func (o *CpixProvider) GetCertificatesIdOk() (*string, bool) {
	if o == nil || IsNil(o.CertificatesId) {
		return nil, false
	}
...
func (o *CpixProvider) SetCertificatesId(v string) {
	o.CertificatesId = &v
}

// GetContentId returns the ContentId field value if set, zero value otherwise.
func (o *CpixProvider) GetContentId() string {
...
// and a boolean to check if the value has been set.
func (o *CpixProvider) GetContentIdOk() (*string, bool) {
	if o == nil || IsNil(o.ContentId) {
		return nil, false
	}
...
func (o *CpixProvider) SetContentId(v string) {
	o.ContentId = &v
}

// GetCredentialsId returns the CredentialsId field value if set, zero value otherwise.
func (o *CpixProvider) GetCredentialsId() string {
...
// and a boolean to check if the value has been set.
func (o *CpixProvider) GetCredentialsIdOk() (*string, bool) {
	if o == nil || IsNil(o.CredentialsId) {
		return nil, false
	}
...
func (o *CpixProvider) SetCredentialsId(v string) {
	o.CredentialsId = &v
}

// GetDecryptionKeyId returns the DecryptionKeyId field value if set, zero value otherwise.
func (o *CpixProvider) GetDecryptionKeyId() string {
...
// and a boolean to check if the value has been set.
func (o *CpixProvider) GetDecryptionKeyIdOk() (*string, bool) {
	if o == nil || IsNil(o.DecryptionKeyId) {
		return nil, false
	}
...
func (o *CpixProvider) GetDrmsOk() ([]string, bool) {
...
func (o *CpixProvider) SetDrms(v []string) {
	o.Drms = v
}

// GetHeadersId returns the HeadersId field value if set, zero value otherwise.
func (o *CpixProvider) GetHeadersId() string {
...
// and a boolean to check if the value has been set.
func (o *CpixProvider) GetHeadersIdOk() (*string, bool) {
	if o == nil || IsNil(o.HeadersId) {
		return nil, false
	}
...
func (o *CpixProvider) SetHeadersId(v string) {
	o.HeadersId = &v
}

// GetUri returns the Uri field value if set, zero value otherwise.
func (o *CpixProvider) GetUri() string {
...
// and a boolean to check if the value has been set.
func (o *CpixProvider) GetUriOk() (*string, bool) {
	if o == nil || IsNil(o.Uri) {
		return nil, false
	}
	return o.Uri, true
...
func (o *CpixProvider) SetUri(v string) {
	o.Uri = &v
}
