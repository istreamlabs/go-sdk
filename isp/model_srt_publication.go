...
func (o *SrtPublication) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SrtPublication) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *SrtPublication) SetId(v string) {
	o.Id = &v
}

// GetPmtPid returns the PmtPid field value if set, zero value otherwise.
func (o *SrtPublication) GetPmtPid() int32 {
...
// and a boolean to check if the value has been set.
func (o *SrtPublication) GetPmtPidOk() (*int32, bool) {
	if o == nil || IsNil(o.PmtPid) {
		return nil, false
	}
...
func (o *SrtPublication) SetPmtPid(v int32) {
	o.PmtPid = &v
}

// GetScte35Pid returns the Scte35Pid field value if set, zero value otherwise.
func (o *SrtPublication) GetScte35Pid() int32 {
...
// and a boolean to check if the value has been set.
func (o *SrtPublication) GetScte35PidOk() (*int32, bool) {
	if o == nil || IsNil(o.Scte35Pid) {
		return nil, false
	}
...
func (o *SrtPublication) SetScte35Pid(v int32) {
	o.Scte35Pid = &v
}

// GetUrl returns the Url field value if set, zero value otherwise.
func (o *SrtPublication) GetUrl() string {
...
// and a boolean to check if the value has been set.
func (o *SrtPublication) GetUrlOk() (*string, bool) {
	if o == nil || IsNil(o.Url) {
		return nil, false
	}
	return o.Url, true
...
func (o *SrtPublication) SetUrl(v string) {
	o.Url = &v
}
