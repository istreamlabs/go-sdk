...
// checks if the PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3{}

// PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3 struct for PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3
type PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3 struct {
...
// NewPatchOrgChannelRequestTranscodeAudioEncodersInnerEac3 instantiates a new PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPatchOrgChannelRequestTranscodeAudioEncodersInnerEac3() *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3 {
	this := PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3{}
	return &this
}

// NewPatchOrgChannelRequestTranscodeAudioEncodersInnerEac3WithDefaults instantiates a new PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPatchOrgChannelRequestTranscodeAudioEncodersInnerEac3WithDefaults() *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3 {
	this := PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3{}
	return &this
}

// GetDdpJocComplexityIndex returns the DdpJocComplexityIndex field value if set, zero value otherwise.
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) GetDdpJocComplexityIndex() int32 {
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) GetDdpJocComplexityIndexOk() (*int32, bool) {
	if o == nil || IsNil(o.DdpJocComplexityIndex) {
		return nil, false
	}
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) HasDdpJocComplexityIndex() bool {
	if o != nil && !IsNil(o.DdpJocComplexityIndex) {
		return true
	}
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) SetDdpJocComplexityIndex(v int32) {
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) GetDdpJocLogicalChannels() int32 {
...
// and a boolean to check if the value has been set.
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) GetDdpJocLogicalChannelsOk() (*int32, bool) {
	if o == nil || IsNil(o.DdpJocLogicalChannels) {
		return nil, false
	}
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) HasDdpJocLogicalChannels() bool {
	if o != nil && !IsNil(o.DdpJocLogicalChannels) {
		return true
	}
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) SetDdpJocLogicalChannels(v int32) {
	o.DdpJocLogicalChannels = &v
}

// GetDdpJocPassthrough returns the DdpJocPassthrough field value if set, zero value otherwise.
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) GetDdpJocPassthrough() bool {
...
// and a boolean to check if the value has been set.
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) GetDdpJocPassthroughOk() (*bool, bool) {
	if o == nil || IsNil(o.DdpJocPassthrough) {
		return nil, false
	}
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) HasDdpJocPassthrough() bool {
	if o != nil && !IsNil(o.DdpJocPassthrough) {
		return true
	}
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) SetDdpJocPassthrough(v bool) {
	o.DdpJocPassthrough = &v
}

// GetDrcLineMode returns the DrcLineMode field value if set, zero value otherwise.
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) GetDrcLineMode() string {
...
// and a boolean to check if the value has been set.
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) GetDrcLineModeOk() (*string, bool) {
	if o == nil || IsNil(o.DrcLineMode) {
		return nil, false
	}
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) HasDrcLineMode() bool {
	if o != nil && !IsNil(o.DrcLineMode) {
		return true
	}
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) SetDrcLineMode(v string) {
	o.DrcLineMode = &v
}

// GetDrcRfMode returns the DrcRfMode field value if set, zero value otherwise.
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) GetDrcRfMode() string {
...
// and a boolean to check if the value has been set.
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) GetDrcRfModeOk() (*string, bool) {
	if o == nil || IsNil(o.DrcRfMode) {
		return nil, false
	}
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) HasDrcRfMode() bool {
	if o != nil && !IsNil(o.DrcRfMode) {
		return true
	}
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) SetDrcRfMode(v string) {
	o.DrcRfMode = &v
}

// GetSurroundPhaseShift returns the SurroundPhaseShift field value if set, zero value otherwise.
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) GetSurroundPhaseShift() string {
...
// and a boolean to check if the value has been set.
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) GetSurroundPhaseShiftOk() (*string, bool) {
	if o == nil || IsNil(o.SurroundPhaseShift) {
		return nil, false
	}
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) HasSurroundPhaseShift() bool {
	if o != nil && !IsNil(o.SurroundPhaseShift) {
		return true
	}
...
func (o *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) SetSurroundPhaseShift(v string) {
...
func (o PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) ToMap() (map[string]interface{}, error) {
...
type NullablePatchOrgChannelRequestTranscodeAudioEncodersInnerEac3 struct {
	value *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3
	isSet bool
}

func (v NullablePatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) Get() *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3 {
	return v.value
}

func (v *NullablePatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) Set(val *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchOrgChannelRequestTranscodeAudioEncodersInnerEac3(val *PatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) *NullablePatchOrgChannelRequestTranscodeAudioEncodersInnerEac3 {
	return &NullablePatchOrgChannelRequestTranscodeAudioEncodersInnerEac3{value: val, isSet: true}
}

func (v NullablePatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchOrgChannelRequestTranscodeAudioEncodersInnerEac3) UnmarshalJSON(src []byte) error {
	v.isSet = true
