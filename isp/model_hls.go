...
func (o *HLS) GetAudioOnlyVariants() string {
...
func (o *HLS) GetAudioOnlyVariantsOk() (*string, bool) {
	if o == nil || IsNil(o.AudioOnlyVariants) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *HLS) GetGapTagsOk() (*string, bool) {
	if o == nil || IsNil(o.GapTags) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *HLS) GetMasterPublishFrequencySecsOk() (*int32, bool) {
	if o == nil || IsNil(o.MasterPublishFrequencySecs) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *HLS) GetMasterUrlTypeOk() (*string, bool) {
	if o == nil || IsNil(o.MasterUrlType) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *HLS) GetMediaUrlTypeOk() (*string, bool) {
	if o == nil || IsNil(o.MediaUrlType) {
		return nil, false
	}
...
func (o *HLS) SetMediaUrlType(v string) {
	o.MediaUrlType = &v
}
...
func (o *HLS) GetPartialPresentations() []HLSPartialPresentationsInner {
	if o == nil {
...
func (o *HLS) GetPartialPresentationsOk() ([]HLSPartialPresentationsInner, bool) {
...
// and a boolean to check if the value has been set.
func (o *HLS) GetPdtOnEverySegmentOk() (*bool, bool) {
	if o == nil || IsNil(o.PdtOnEverySegment) {
		return nil, false
	}
...
func (o *HLS) SetPdtOnEverySegment(v bool) {
...
func (o *HLS) GetSignalingFormats() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *HLS) GetSignalingFormatsOk() ([]string, bool) {
...
// and a boolean to check if the value has been set.
func (o *HLS) GetUtcInSegmentTitleOk() (*bool, bool) {
	if o == nil || IsNil(o.UtcInSegmentTitle) {
		return nil, false
	}
...
func (o *HLS) SetUtcInSegmentTitle(v bool) {
