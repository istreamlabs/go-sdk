...
type Location struct {
	FallbackUrl interface{} `json:"fallback_url"`
	PrimaryUrl interface{} `json:"primary_url"`
...
func NewLocation(fallbackUrl interface{}, primaryUrl interface{}, queryString interface{}) *Location {
	this := Location{}
...
func (o *Location) GetFallbackUrl() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *Location) GetFallbackUrlOk() (*interface{}, bool) {
...
func (o *Location) SetFallbackUrl(v interface{}) {
	o.FallbackUrl = v
}

// GetPrimaryUrl returns the PrimaryUrl field value
// If the value is explicit nil, the zero value for interface{} will be returned
func (o *Location) GetPrimaryUrl() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Location) GetPrimaryUrlOk() (*interface{}, bool) {
...
func (o *Location) SetPrimaryUrl(v interface{}) {
	o.PrimaryUrl = v
}

// GetQueryString returns the QueryString field value
// If the value is explicit nil, the zero value for interface{} will be returned
func (o *Location) GetQueryString() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Location) GetQueryStringOk() (*interface{}, bool) {
...
func (o *Location) SetQueryString(v interface{}) {
	o.QueryString = v
}
