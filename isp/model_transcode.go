...
func (o *Transcode) GetAudioEncoders() []PatchOrgChannelRequestTranscodeAudioEncodersInner {
	if o == nil {
...
func (o *Transcode) GetAudioEncodersOk() ([]PatchOrgChannelRequestTranscodeAudioEncodersInner, bool) {
...
func (o *Transcode) SetAudioEncoders(v []PatchOrgChannelRequestTranscodeAudioEncodersInner) {
	o.AudioEncoders = v
}

// GetDebugOverlay returns the DebugOverlay field value if set, zero value otherwise.
// Deprecated
func (o *Transcode) GetDebugOverlay() bool {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *Transcode) GetDebugOverlayOk() (*bool, bool) {
	if o == nil || IsNil(o.DebugOverlay) {
		return nil, false
	}
...
// Deprecated
func (o *Transcode) SetDebugOverlay(v bool) {
	o.DebugOverlay = &v
}
...
func (o *Transcode) GetFeatureFlags() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Transcode) GetFeatureFlagsOk() ([]string, bool) {
...
func (o *Transcode) SetFeatureFlags(v []string) {
	o.FeatureFlags = v
}

// GetId3Mode returns the Id3Mode field value if set, zero value otherwise.
func (o *Transcode) GetId3Mode() string {
...
// and a boolean to check if the value has been set.
func (o *Transcode) GetId3ModeOk() (*string, bool) {
	if o == nil || IsNil(o.Id3Mode) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Transcode) GetOverlaysOk() ([]PatchOrgChannelRequestTranscodeOverlaysInner, bool) {
...
func (o *Transcode) SetOverlays(v []PatchOrgChannelRequestTranscodeOverlaysInner) {
	o.Overlays = v
}

// GetResizeMode returns the ResizeMode field value if set, zero value otherwise.
// Deprecated
func (o *Transcode) GetResizeMode() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *Transcode) GetResizeModeOk() (*string, bool) {
	if o == nil || IsNil(o.ResizeMode) {
		return nil, false
	}
...
// Deprecated
func (o *Transcode) SetResizeMode(v string) {
	o.ResizeMode = &v
}
...
func (o *Transcode) GetSubtitleEncoders() []PatchOrgChannelRequestTranscodeSubtitleEncodersInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Transcode) GetSubtitleEncodersOk() ([]PatchOrgChannelRequestTranscodeSubtitleEncodersInner, bool) {
...
func (o *Transcode) SetSubtitleEncoders(v []PatchOrgChannelRequestTranscodeSubtitleEncodersInner) {
...
func (o *Transcode) GetThumbnailEncoders() []PatchOrgChannelRequestTranscodeThumbnailEncodersInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Transcode) GetThumbnailEncodersOk() ([]PatchOrgChannelRequestTranscodeThumbnailEncodersInner, bool) {
...
func (o *Transcode) SetThumbnailEncoders(v []PatchOrgChannelRequestTranscodeThumbnailEncodersInner) {
...
func (o *Transcode) GetVideoEncoders() []PutChannelRequestBodyTranscodeVideoEncodersInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Transcode) GetVideoEncodersOk() ([]PutChannelRequestBodyTranscodeVideoEncodersInner, bool) {
...
func (o *Transcode) SetVideoEncoders(v []PutChannelRequestBodyTranscodeVideoEncodersInner) {
	o.VideoEncoders = v
}
