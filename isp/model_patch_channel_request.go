...
func (o *PatchChannelRequest) GetEnableByoip() bool {
...
// and a boolean to check if the value has been set.
func (o *PatchChannelRequest) GetEnableByoipOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableByoip) {
		return nil, false
	}
...
func (o *PatchChannelRequest) HasEnableByoip() bool {
	if o != nil && !IsNil(o.EnableByoip) {
		return true
	}
...
func (o *PatchChannelRequest) SetEnableByoip(v bool) {
	o.EnableByoip = &v
}
