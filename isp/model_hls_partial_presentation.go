...
func (o *HLSPartialPresentation) GetAudioEncoderIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *HLSPartialPresentation) GetAudioEncoderIdsOk() ([]string, bool) {
...
func (o *HLSPartialPresentation) SetAudioEncoderIds(v []string) {
	o.AudioEncoderIds = v
}
...
func (o *HLSPartialPresentation) GetFerAudioEncoderIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *HLSPartialPresentation) GetFerAudioEncoderIdsOk() ([]string, bool) {
...
func (o *HLSPartialPresentation) SetFerAudioEncoderIds(v []string) {
...
func (o *HLSPartialPresentation) GetIframeOnlyEncoderIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *HLSPartialPresentation) GetIframeOnlyEncoderIdsOk() ([]string, bool) {
...
func (o *HLSPartialPresentation) SetIframeOnlyEncoderIds(v []string) {
	o.IframeOnlyEncoderIds = v
}

// GetPlaylistPath returns the PlaylistPath field value if set, zero value otherwise.
func (o *HLSPartialPresentation) GetPlaylistPath() string {
...
// and a boolean to check if the value has been set.
func (o *HLSPartialPresentation) GetPlaylistPathOk() (*string, bool) {
	if o == nil || IsNil(o.PlaylistPath) {
		return nil, false
	}
...
func (o *HLSPartialPresentation) SetPlaylistPath(v string) {
	o.PlaylistPath = &v
}
...
func (o *HLSPartialPresentation) GetThumbnailEncoderIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *HLSPartialPresentation) GetThumbnailEncoderIdsOk() ([]string, bool) {
...
func (o *HLSPartialPresentation) SetThumbnailEncoderIds(v []string) {
...
func (o *HLSPartialPresentation) GetVideoEncoderIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *HLSPartialPresentation) GetVideoEncoderIdsOk() ([]string, bool) {
...
func (o *HLSPartialPresentation) SetVideoEncoderIds(v []string) {
	o.VideoEncoderIds = v
}
