...
func (o *Segmenter) GetGopDurationSecs() float64 {
...
func (o *Segmenter) GetGopDurationSecsOk() (*float64, bool) {
	if o == nil || IsNil(o.GopDurationSecs) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Segmenter) GetSegmentDurationSecsOk() (*float64, bool) {
	if o == nil || IsNil(o.SegmentDurationSecs) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Segmenter) GetTemiOk() (*bool, bool) {
	if o == nil || IsNil(o.Temi) {
		return nil, false
	}
	return o.Temi, true
...
func (o *Segmenter) SetTemi(v bool) {
	o.Temi = &v
}
