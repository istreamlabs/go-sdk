...
type ChannelsApi interface {
	 ...
	 * Create a new channel configuration and start publishing.
	 ...
	 */
	CreateChannelExecute(r ApiCreateChannelRequest) (*_nethttp.Response, GenericOpenAPIError)
...
func (r ApiCreateChannelRequest) Execute() (*_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return ApiCreateChannelRequest
 */
func (a *ChannelsApiService) CreateChannel(ctx _context.Context) ApiCreateChannelRequest {
	return ApiCreateChannelRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *ChannelsApiService) CreateChannelExecute(r ApiCreateChannelRequest) (*_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiPutChannelRequest) Channel(channel Channel) ApiPutChannelRequest {
	r.channel = &channel
	return r
}
