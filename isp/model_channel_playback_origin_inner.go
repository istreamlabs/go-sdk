...
func (o *ChannelPlaybackOriginInner) GetHls() ChannelPlaybackOriginInnerDash {
...
// and a boolean to check if the value has been set.
func (o *ChannelPlaybackOriginInner) GetHlsOk() (*ChannelPlaybackOriginInnerDash, bool) {
	if o == nil || IsNil(o.Hls) {
		return nil, false
	}
	return o.Hls, true
...
// SetHls gets a reference to the given ChannelPlaybackOriginInnerDash and assigns it to the Hls field.
func (o *ChannelPlaybackOriginInner) SetHls(v ChannelPlaybackOriginInnerDash) {
	o.Hls = &v
}
