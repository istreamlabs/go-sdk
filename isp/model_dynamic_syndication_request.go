...
func NewDynamicSyndicationRequest(archive DynamicArchiveMP4RequestArchive, correlationId string, manifestUrl string, notification DynamicArchiveMP4RequestNotification, queryString string, syndicationFiles []DynamicSyndicationRequestSyndicationFilesInner) *DynamicSyndicationRequest {
...
func (o *DynamicSyndicationRequest) GetArchive() DynamicArchiveMP4RequestArchive {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *DynamicSyndicationRequest) GetArchiveOk() (*DynamicArchiveMP4RequestArchive, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DynamicSyndicationRequest) SetArchive(v DynamicArchiveMP4RequestArchive) {
	o.Archive = v
}
...
func (o *DynamicSyndicationRequest) GetNotification() DynamicArchiveMP4RequestNotification {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *DynamicSyndicationRequest) GetNotificationOk() (*DynamicArchiveMP4RequestNotification, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DynamicSyndicationRequest) SetNotification(v DynamicArchiveMP4RequestNotification) {
	o.Notification = v
}
