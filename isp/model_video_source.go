...
func (o *VideoSource) GetDynamicRange() string {
...
func (o *VideoSource) GetDynamicRangeOk() (*string, bool) {
	if o == nil || IsNil(o.DynamicRange) {
		return nil, false
	}
...
func (o *VideoSource) SetDynamicRange(v string) {
	o.DynamicRange = &v
}

// GetMaxResolution returns the MaxResolution field value if set, zero value otherwise.
func (o *VideoSource) GetMaxResolution() string {
...
// and a boolean to check if the value has been set.
func (o *VideoSource) GetMaxResolutionOk() (*string, bool) {
	if o == nil || IsNil(o.MaxResolution) {
		return nil, false
	}
...
func (o *VideoSource) SetMaxResolution(v string) {
	o.MaxResolution = &v
}
