...
// checks if the PublishingPublicationsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublishingPublicationsInner{}

// PublishingPublicationsInner struct for PublishingPublicationsInner
type PublishingPublicationsInner struct {
...
// NewPublishingPublicationsInner instantiates a new PublishingPublicationsInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPublishingPublicationsInner() *PublishingPublicationsInner {
	this := PublishingPublicationsInner{}
	return &this
}

// NewPublishingPublicationsInnerWithDefaults instantiates a new PublishingPublicationsInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPublishingPublicationsInnerWithDefaults() *PublishingPublicationsInner {
	this := PublishingPublicationsInner{}
	return &this
}
...
func (o *PublishingPublicationsInner) GetAudioEncoderIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *PublishingPublicationsInner) GetAudioEncoderIdsOk() ([]string, bool) {
...
func (o *PublishingPublicationsInner) HasAudioEncoderIds() bool {
	if o != nil && IsNil(o.AudioEncoderIds) {
		return true
	}
...
func (o *PublishingPublicationsInner) SetAudioEncoderIds(v []string) {
	o.AudioEncoderIds = v
}

// GetCreateVods returns the CreateVods field value if set, zero value otherwise.
func (o *PublishingPublicationsInner) GetCreateVods() bool {
...
// and a boolean to check if the value has been set.
func (o *PublishingPublicationsInner) GetCreateVodsOk() (*bool, bool) {
	if o == nil || IsNil(o.CreateVods) {
		return nil, false
	}
...
func (o *PublishingPublicationsInner) HasCreateVods() bool {
	if o != nil && !IsNil(o.CreateVods) {
		return true
	}
...
func (o *PublishingPublicationsInner) SetCreateVods(v bool) {
	o.CreateVods = &v
}
...
func (o *PublishingPublicationsInner) HasDash() bool {
	if o != nil && !IsNil(o.Dash) {
		return true
	}
...
func (o *PublishingPublicationsInner) GetDrms() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PublishingPublicationsInner) GetDrmsOk() ([]string, bool) {
...
func (o *PublishingPublicationsInner) HasDrms() bool {
	if o != nil && IsNil(o.Drms) {
		return true
	}
...
func (o *PublishingPublicationsInner) SetDrms(v []string) {
	o.Drms = v
}

// GetDvrWindowSecs returns the DvrWindowSecs field value if set, zero value otherwise.
func (o *PublishingPublicationsInner) GetDvrWindowSecs() int32 {
...
// and a boolean to check if the value has been set.
func (o *PublishingPublicationsInner) GetDvrWindowSecsOk() (*int32, bool) {
	if o == nil || IsNil(o.DvrWindowSecs) {
		return nil, false
	}
...
func (o *PublishingPublicationsInner) HasDvrWindowSecs() bool {
	if o != nil && !IsNil(o.DvrWindowSecs) {
		return true
	}
...
func (o *PublishingPublicationsInner) SetDvrWindowSecs(v int32) {
	o.DvrWindowSecs = &v
}
...
func (o *PublishingPublicationsInner) GetFerAudioEncoderIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PublishingPublicationsInner) GetFerAudioEncoderIdsOk() ([]string, bool) {
...
func (o *PublishingPublicationsInner) HasFerAudioEncoderIds() bool {
	if o != nil && IsNil(o.FerAudioEncoderIds) {
		return true
	}
...
func (o *PublishingPublicationsInner) SetFerAudioEncoderIds(v []string) {
...
func (o *PublishingPublicationsInner) HasHls() bool {
	if o != nil && !IsNil(o.Hls) {
		return true
	}
...
func (o *PublishingPublicationsInner) GetIframeOnlyEncoderIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PublishingPublicationsInner) GetIframeOnlyEncoderIdsOk() ([]string, bool) {
...
func (o *PublishingPublicationsInner) HasIframeOnlyEncoderIds() bool {
	if o != nil && IsNil(o.IframeOnlyEncoderIds) {
		return true
	}
...
func (o *PublishingPublicationsInner) SetIframeOnlyEncoderIds(v []string) {
	o.IframeOnlyEncoderIds = v
}

// GetMasterPlaylistName returns the MasterPlaylistName field value if set, zero value otherwise.
func (o *PublishingPublicationsInner) GetMasterPlaylistName() string {
...
// and a boolean to check if the value has been set.
func (o *PublishingPublicationsInner) GetMasterPlaylistNameOk() (*string, bool) {
	if o == nil || IsNil(o.MasterPlaylistName) {
		return nil, false
	}
...
func (o *PublishingPublicationsInner) HasMasterPlaylistName() bool {
	if o != nil && !IsNil(o.MasterPlaylistName) {
		return true
	}
...
func (o *PublishingPublicationsInner) SetMasterPlaylistName(v string) {
...
func (o *PublishingPublicationsInner) HasOrigin() bool {
	if o != nil && !IsNil(o.Origin) {
		return true
	}
...
func (o *PublishingPublicationsInner) GetPackagerId() string {
...
// and a boolean to check if the value has been set.
func (o *PublishingPublicationsInner) GetPackagerIdOk() (*string, bool) {
	if o == nil || IsNil(o.PackagerId) {
		return nil, false
	}
...
func (o *PublishingPublicationsInner) HasPackagerId() bool {
	if o != nil && !IsNil(o.PackagerId) {
		return true
	}
...
func (o *PublishingPublicationsInner) SetPackagerId(v string) {
	o.PackagerId = &v
}
...
func (o *PublishingPublicationsInner) HasPublishPoints() bool {
	if o != nil && IsNil(o.PublishPoints) {
		return true
	}
...
func (o *PublishingPublicationsInner) GetRedundantPublishing() bool {
...
// and a boolean to check if the value has been set.
func (o *PublishingPublicationsInner) GetRedundantPublishingOk() (*bool, bool) {
	if o == nil || IsNil(o.RedundantPublishing) {
		return nil, false
	}
...
func (o *PublishingPublicationsInner) HasRedundantPublishing() bool {
	if o != nil && !IsNil(o.RedundantPublishing) {
		return true
	}
...
func (o *PublishingPublicationsInner) SetRedundantPublishing(v bool) {
	o.RedundantPublishing = &v
}

// GetStartover returns the Startover field value if set, zero value otherwise.
func (o *PublishingPublicationsInner) GetStartover() PatchOrgChannelRequestPublishingPublicationsInnerStartover {
...
// and a boolean to check if the value has been set.
func (o *PublishingPublicationsInner) GetStartoverOk() (*PatchOrgChannelRequestPublishingPublicationsInnerStartover, bool) {
	if o == nil || IsNil(o.Startover) {
		return nil, false
	}
...
func (o *PublishingPublicationsInner) HasStartover() bool {
	if o != nil && !IsNil(o.Startover) {
		return true
	}
...
func (o *PublishingPublicationsInner) SetStartover(v PatchOrgChannelRequestPublishingPublicationsInnerStartover) {
	o.Startover = &v
}
...
func (o *PublishingPublicationsInner) GetThumbnailEncoderIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PublishingPublicationsInner) GetThumbnailEncoderIdsOk() ([]string, bool) {
...
func (o *PublishingPublicationsInner) HasThumbnailEncoderIds() bool {
	if o != nil && IsNil(o.ThumbnailEncoderIds) {
		return true
	}
...
func (o *PublishingPublicationsInner) SetThumbnailEncoderIds(v []string) {
	o.ThumbnailEncoderIds = v
}

// GetUseStrictBitrate returns the UseStrictBitrate field value if set, zero value otherwise.
func (o *PublishingPublicationsInner) GetUseStrictBitrate() bool {
...
// and a boolean to check if the value has been set.
func (o *PublishingPublicationsInner) GetUseStrictBitrateOk() (*bool, bool) {
	if o == nil || IsNil(o.UseStrictBitrate) {
		return nil, false
	}
...
func (o *PublishingPublicationsInner) HasUseStrictBitrate() bool {
	if o != nil && !IsNil(o.UseStrictBitrate) {
		return true
	}
...
func (o *PublishingPublicationsInner) SetUseStrictBitrate(v bool) {
...
func (o *PublishingPublicationsInner) GetVideoEncoderIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PublishingPublicationsInner) GetVideoEncoderIdsOk() ([]string, bool) {
...
func (o *PublishingPublicationsInner) HasVideoEncoderIds() bool {
	if o != nil && IsNil(o.VideoEncoderIds) {
		return true
	}
...
func (o *PublishingPublicationsInner) SetVideoEncoderIds(v []string) {
	o.VideoEncoderIds = v
}

func (o PublishingPublicationsInner) MarshalJSON() ([]byte, error) {
...
func (o PublishingPublicationsInner) ToMap() (map[string]interface{}, error) {
...
type NullablePublishingPublicationsInner struct {
	value *PublishingPublicationsInner
	isSet bool
}

func (v NullablePublishingPublicationsInner) Get() *PublishingPublicationsInner {
	return v.value
}

func (v *NullablePublishingPublicationsInner) Set(val *PublishingPublicationsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePublishingPublicationsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePublishingPublicationsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublishingPublicationsInner(val *PublishingPublicationsInner) *NullablePublishingPublicationsInner {
	return &NullablePublishingPublicationsInner{value: val, isSet: true}
}

func (v NullablePublishingPublicationsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublishingPublicationsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
