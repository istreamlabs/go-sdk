...
func (o *VideoEncoder) GetBitRate() int32 {
...
func (o *VideoEncoder) GetBitRateOk() (*int32, bool) {
	if o == nil || IsNil(o.BitRate) {
		return nil, false
	}
...
func (o *VideoEncoder) SetBitRate(v int32) {
	o.BitRate = &v
}

// GetFrameRate returns the FrameRate field value if set, zero value otherwise.
func (o *VideoEncoder) GetFrameRate() string {
...
// and a boolean to check if the value has been set.
func (o *VideoEncoder) GetFrameRateOk() (*string, bool) {
	if o == nil || IsNil(o.FrameRate) {
		return nil, false
	}
...
func (o *VideoEncoder) SetFrameRate(v string) {
	o.FrameRate = &v
}

// GetH264 returns the H264 field value if set, zero value otherwise.
func (o *VideoEncoder) GetH264() PatchOrgChannelRequestTranscodeVideoEncodersInnerH264 {
...
// and a boolean to check if the value has been set.
func (o *VideoEncoder) GetH264Ok() (*PatchOrgChannelRequestTranscodeVideoEncodersInnerH264, bool) {
	if o == nil || IsNil(o.H264) {
		return nil, false
	}
	return o.H264, true
...
func (o *VideoEncoder) SetH264(v PatchOrgChannelRequestTranscodeVideoEncodersInnerH264) {
	o.H264 = &v
}

// GetH265 returns the H265 field value if set, zero value otherwise.
func (o *VideoEncoder) GetH265() PutChannelRequestBodyTranscodeVideoEncodersInnerH265 {
...
// and a boolean to check if the value has been set.
func (o *VideoEncoder) GetH265Ok() (*PutChannelRequestBodyTranscodeVideoEncodersInnerH265, bool) {
	if o == nil || IsNil(o.H265) {
		return nil, false
	}
	return o.H265, true
...
func (o *VideoEncoder) SetH265(v PutChannelRequestBodyTranscodeVideoEncodersInnerH265) {
	o.H265 = &v
}

// GetHeight returns the Height field value if set, zero value otherwise.
func (o *VideoEncoder) GetHeight() int32 {
...
// and a boolean to check if the value has been set.
func (o *VideoEncoder) GetHeightOk() (*int32, bool) {
	if o == nil || IsNil(o.Height) {
		return nil, false
	}
...
func (o *VideoEncoder) SetHeight(v int32) {
	o.Height = &v
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *VideoEncoder) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VideoEncoder) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
// and a boolean to check if the value has been set.
func (o *VideoEncoder) GetResizeModeOk() (*string, bool) {
	if o == nil || IsNil(o.ResizeMode) {
		return nil, false
	}
...
func (o *VideoEncoder) SetResizeMode(v string) {
	o.ResizeMode = &v
}

// GetWidth returns the Width field value if set, zero value otherwise.
func (o *VideoEncoder) GetWidth() int32 {
...
// and a boolean to check if the value has been set.
func (o *VideoEncoder) GetWidthOk() (*int32, bool) {
	if o == nil || IsNil(o.Width) {
		return nil, false
	}
	return o.Width, true
...
func (o *VideoEncoder) SetWidth(v int32) {
	o.Width = &v
}
