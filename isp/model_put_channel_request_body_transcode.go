...
type PutChannelRequestBodyTranscode struct {
	...
	VideoEncoders []PutChannelRequestBodyTranscodeVideoEncodersInner `json:"video_encoders,omitempty" minItems:"1" doc:"Video encoders specify video conversion settings, e.g. dimensions, codec, bitrate, etc."`
}
...
func (o *PutChannelRequestBodyTranscode) GetAudioEncoders() []PatchOrgChannelRequestTranscodeAudioEncodersInner {
	if o == nil {
...
func (o *PutChannelRequestBodyTranscode) GetAudioEncodersOk() ([]PatchOrgChannelRequestTranscodeAudioEncodersInner, bool) {
...
func (o *PutChannelRequestBodyTranscode) SetAudioEncoders(v []PatchOrgChannelRequestTranscodeAudioEncodersInner) {
	o.AudioEncoders = v
}

// GetDebugOverlay returns the DebugOverlay field value if set, zero value otherwise.
// Deprecated
func (o *PutChannelRequestBodyTranscode) GetDebugOverlay() bool {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *PutChannelRequestBodyTranscode) GetDebugOverlayOk() (*bool, bool) {
	if o == nil || IsNil(o.DebugOverlay) {
		return nil, false
	}
...
// Deprecated
func (o *PutChannelRequestBodyTranscode) SetDebugOverlay(v bool) {
	o.DebugOverlay = &v
}
...
func (o *PutChannelRequestBodyTranscode) GetFeatureFlags() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PutChannelRequestBodyTranscode) GetFeatureFlagsOk() ([]string, bool) {
...
func (o *PutChannelRequestBodyTranscode) SetFeatureFlags(v []string) {
	o.FeatureFlags = v
}

// GetId3Mode returns the Id3Mode field value if set, zero value otherwise.
func (o *PutChannelRequestBodyTranscode) GetId3Mode() string {
...
// and a boolean to check if the value has been set.
func (o *PutChannelRequestBodyTranscode) GetId3ModeOk() (*string, bool) {
	if o == nil || IsNil(o.Id3Mode) {
		return nil, false
	}
...
func (o *PutChannelRequestBodyTranscode) SetId3Mode(v string) {
	o.Id3Mode = &v
}

// GetOverlays returns the Overlays field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PutChannelRequestBodyTranscode) GetOverlays() []PatchOrgChannelRequestTranscodeOverlaysInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PutChannelRequestBodyTranscode) GetOverlaysOk() ([]PatchOrgChannelRequestTranscodeOverlaysInner, bool) {
...
func (o *PutChannelRequestBodyTranscode) SetOverlays(v []PatchOrgChannelRequestTranscodeOverlaysInner) {
	o.Overlays = v
}

// GetResizeMode returns the ResizeMode field value if set, zero value otherwise.
// Deprecated
func (o *PutChannelRequestBodyTranscode) GetResizeMode() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *PutChannelRequestBodyTranscode) GetResizeModeOk() (*string, bool) {
	if o == nil || IsNil(o.ResizeMode) {
		return nil, false
	}
...
// Deprecated
func (o *PutChannelRequestBodyTranscode) SetResizeMode(v string) {
	o.ResizeMode = &v
}
...
func (o *PutChannelRequestBodyTranscode) GetSubtitleEncoders() []PatchOrgChannelRequestTranscodeSubtitleEncodersInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PutChannelRequestBodyTranscode) GetSubtitleEncodersOk() ([]PatchOrgChannelRequestTranscodeSubtitleEncodersInner, bool) {
...
func (o *PutChannelRequestBodyTranscode) SetSubtitleEncoders(v []PatchOrgChannelRequestTranscodeSubtitleEncodersInner) {
...
func (o *PutChannelRequestBodyTranscode) GetThumbnailEncoders() []PatchOrgChannelRequestTranscodeThumbnailEncodersInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PutChannelRequestBodyTranscode) GetThumbnailEncodersOk() ([]PatchOrgChannelRequestTranscodeThumbnailEncodersInner, bool) {
...
func (o *PutChannelRequestBodyTranscode) SetThumbnailEncoders(v []PatchOrgChannelRequestTranscodeThumbnailEncodersInner) {
...
func (o *PutChannelRequestBodyTranscode) GetVideoEncoders() []PutChannelRequestBodyTranscodeVideoEncodersInner {
	if o == nil {
		var ret []PutChannelRequestBodyTranscodeVideoEncodersInner
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PutChannelRequestBodyTranscode) GetVideoEncodersOk() ([]PutChannelRequestBodyTranscodeVideoEncodersInner, bool) {
...
// SetVideoEncoders gets a reference to the given []PutChannelRequestBodyTranscodeVideoEncodersInner and assigns it to the VideoEncoders field.
func (o *PutChannelRequestBodyTranscode) SetVideoEncoders(v []PutChannelRequestBodyTranscodeVideoEncodersInner) {
	o.VideoEncoders = v
}
