...
func NewTask(created time.Time, done bool, ended time.Time, error_ string, failureCount int64, id string, params string, progress float64, status string, succeeded bool, type_ int64, weight int64, workerVersion string, workerId int64) *Task {
	this := Task{}
...
func (o *Task) GetFailureCount() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Task) GetFailureCountOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Task) SetFailureCount(v int64) {
	o.FailureCount = v
}
...
// and a boolean to check if the value has been set.
func (o *Task) GetParamsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Task) SetParams(v string) {
	o.Params = v
}

// GetProgress returns the Progress field value
func (o *Task) GetProgress() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Task) GetProgressOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Task) SetProgress(v float64) {
	o.Progress = v
}

// GetRegion returns the Region field value if set, zero value otherwise.
func (o *Task) GetRegion() string {
...
// and a boolean to check if the value has been set.
func (o *Task) GetRegionOk() (*string, bool) {
	if o == nil || IsNil(o.Region) {
		return nil, false
	}
...
func (o *Task) SetRegion(v string) {
	o.Region = &v
}
...
// and a boolean to check if the value has been set.
func (o *Task) GetSucceededOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Task) SetSucceeded(v bool) {
	o.Succeeded = v
}

// GetType returns the Type field value
func (o *Task) GetType() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Task) GetTypeOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *Task) SetType(v int64) {
	o.Type = v
}

// GetWeight returns the Weight field value
func (o *Task) GetWeight() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Task) GetWeightOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Task) SetWeight(v int64) {
	o.Weight = v
}

// GetWorkerVersion returns the WorkerVersion field value
func (o *Task) GetWorkerVersion() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Task) GetWorkerVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Task) SetWorkerVersion(v string) {
	o.WorkerVersion = v
}

// GetWorkerId returns the WorkerId field value
func (o *Task) GetWorkerId() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Task) GetWorkerIdOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Task) SetWorkerId(v int64) {
	o.WorkerId = v
}
