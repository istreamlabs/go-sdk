...
type SlatesForOrganizationApi interface {
	...
	*/
	...
	//  @return Slate1
	GetOrgSlateExecute(r ApiGetOrgSlateRequest) (*Slate1, *http.Response, error)
	...
	*/
	...
	//  @return Slate1
	PutOrgSlateExecute(r ApiPutOrgSlateRequest) (*Slate1, *http.Response, error)
}
...
func (r ApiGetOrgSlateRequest) Execute() (*Slate1, *http.Response, error) {
...
// Execute executes the request
//  @return Slate1
func (a *SlatesForOrganizationApiService) GetOrgSlateExecute(r ApiGetOrgSlateRequest) (*Slate1, *http.Response, error) {
	var (
...
func (r ApiPutOrgSlateRequest) Execute() (*Slate1, *http.Response, error) {
...
// Execute executes the request
//  @return Slate1
func (a *SlatesForOrganizationApiService) PutOrgSlateExecute(r ApiPutOrgSlateRequest) (*Slate1, *http.Response, error) {
	var (
