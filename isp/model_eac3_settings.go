...
func (o *Eac3Settings) GetDdpJocComplexityIndex() int32 {
...
func (o *Eac3Settings) GetDdpJocComplexityIndexOk() (*int32, bool) {
	if o == nil || IsNil(o.DdpJocComplexityIndex) {
		return nil, false
	}
...
func (o *Eac3Settings) SetDdpJocComplexityIndex(v int32) {
...
func (o *Eac3Settings) GetDdpJocLogicalChannels() int32 {
...
// and a boolean to check if the value has been set.
func (o *Eac3Settings) GetDdpJocLogicalChannelsOk() (*int32, bool) {
	if o == nil || IsNil(o.DdpJocLogicalChannels) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Eac3Settings) GetDdpJocPassthroughOk() (*bool, bool) {
	if o == nil || IsNil(o.DdpJocPassthrough) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Eac3Settings) GetDrcLineModeOk() (*string, bool) {
	if o == nil || IsNil(o.DrcLineMode) {
		return nil, false
	}
...
func (o *Eac3Settings) SetDrcLineMode(v string) {
	o.DrcLineMode = &v
}

// GetDrcRfMode returns the DrcRfMode field value if set, zero value otherwise.
func (o *Eac3Settings) GetDrcRfMode() string {
...
// and a boolean to check if the value has been set.
func (o *Eac3Settings) GetDrcRfModeOk() (*string, bool) {
	if o == nil || IsNil(o.DrcRfMode) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Eac3Settings) GetSurroundPhaseShiftOk() (*string, bool) {
	if o == nil || IsNil(o.SurroundPhaseShift) {
		return nil, false
	}
...
func (o *Eac3Settings) SetSurroundPhaseShift(v string) {
