...
// checks if the Eac3Settings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Eac3Settings{}

// Eac3Settings struct for Eac3Settings
...
// NewEac3Settings instantiates a new Eac3Settings object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEac3Settings() *Eac3Settings {
	this := Eac3Settings{}
	return &this
}

// NewEac3SettingsWithDefaults instantiates a new Eac3Settings object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewEac3SettingsWithDefaults() *Eac3Settings {
	this := Eac3Settings{}
	return &this
}
...
func (o *Eac3Settings) GetDdpJocComplexityIndex() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *Eac3Settings) GetDdpJocComplexityIndexOk() (*interface{}, bool) {
...
func (o *Eac3Settings) HasDdpJocComplexityIndex() bool {
	if o != nil && IsNil(o.DdpJocComplexityIndex) {
		return true
	}
...
func (o *Eac3Settings) SetDdpJocComplexityIndex(v interface{}) {
...
func (o *Eac3Settings) GetDdpJocLogicalChannels() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Eac3Settings) GetDdpJocLogicalChannelsOk() (*interface{}, bool) {
...
func (o *Eac3Settings) HasDdpJocLogicalChannels() bool {
	if o != nil && IsNil(o.DdpJocLogicalChannels) {
		return true
	}
...
func (o *Eac3Settings) SetDdpJocLogicalChannels(v interface{}) {
...
func (o *Eac3Settings) GetDdpJocPassthrough() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Eac3Settings) GetDdpJocPassthroughOk() (*interface{}, bool) {
...
func (o *Eac3Settings) HasDdpJocPassthrough() bool {
	if o != nil && IsNil(o.DdpJocPassthrough) {
		return true
	}
...
func (o *Eac3Settings) SetDdpJocPassthrough(v interface{}) {
...
func (o *Eac3Settings) GetDrcLineMode() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Eac3Settings) GetDrcLineModeOk() (*interface{}, bool) {
...
func (o *Eac3Settings) HasDrcLineMode() bool {
	if o != nil && IsNil(o.DrcLineMode) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Eac3Settings) GetDrcRfModeOk() (*interface{}, bool) {
...
func (o *Eac3Settings) HasDrcRfMode() bool {
	if o != nil && IsNil(o.DrcRfMode) {
		return true
	}
...
func (o *Eac3Settings) SetDrcRfMode(v interface{}) {
	o.DrcRfMode = v
}
...
func (o *Eac3Settings) GetSurroundPhaseShift() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Eac3Settings) GetSurroundPhaseShiftOk() (*interface{}, bool) {
...
func (o *Eac3Settings) HasSurroundPhaseShift() bool {
	if o != nil && IsNil(o.SurroundPhaseShift) {
		return true
	}
...
func (o *Eac3Settings) SetSurroundPhaseShift(v interface{}) {
	o.SurroundPhaseShift = v
}

func (o Eac3Settings) MarshalJSON() ([]byte, error) {
...
func (o Eac3Settings) ToMap() (map[string]interface{}, error) {
...
type NullableEac3Settings struct {
	value *Eac3Settings
	isSet bool
}

func (v NullableEac3Settings) Get() *Eac3Settings {
	return v.value
}

func (v *NullableEac3Settings) Set(val *Eac3Settings) {
	v.value = val
	v.isSet = true
}

func (v NullableEac3Settings) IsSet() bool {
	return v.isSet
}

func (v *NullableEac3Settings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEac3Settings(val *Eac3Settings) *NullableEac3Settings {
	return &NullableEac3Settings{value: val, isSet: true}
}

func (v NullableEac3Settings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEac3Settings) UnmarshalJSON(src []byte) error {
	v.isSet = true
