...
Get a slate by id.
	...
	*/
	...
	//  @return Slate1
	// Deprecated
	GetSlateExecute(r ApiGetSlateRequest) (*Slate1, *http.Response, error)
...
Create or update a slate by id.  The URL of the slate must already exist.
	...
	*/
	...
	//  @return Slate1
	// Deprecated
	PutSlateExecute(r ApiPutSlateRequest) (*Slate1, *http.Response, error)
}
...
func (r ApiGetSlateRequest) Execute() (*Slate1, *http.Response, error) {
...
//  @return Slate1
// Deprecated
func (a *SlateOperationsApiService) GetSlateExecute(r ApiGetSlateRequest) (*Slate1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *Slate1
	)
	...
	if disablePaging := r.ctx.Value(ContextDisablePaging); disablePaging == nil {
		if uri := GetLink(localVarHTTPResponse, RelNext); uri != nil {
			...
			localVarReturnValue = items.(*Slate1)
...
func (r ApiPutSlateRequest) Execute() (*Slate1, *http.Response, error) {
...
//  @return Slate1
// Deprecated
func (a *SlateOperationsApiService) PutSlateExecute(r ApiPutSlateRequest) (*Slate1, *http.Response, error) {
	var (
