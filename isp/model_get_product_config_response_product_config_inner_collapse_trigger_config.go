...
type GetProductConfigResponseProductConfigInnerCollapseTriggerConfig struct {
	...
	Triggers []GetProductConfigResponseProductConfigInnerCollapseTriggerConfigTriggersInner `json:"triggers"`
}
...
func NewGetProductConfigResponseProductConfigInnerCollapseTriggerConfig(allowMultiple bool, collapseProgram bool, collapseStream bool, triggers []GetProductConfigResponseProductConfigInnerCollapseTriggerConfigTriggersInner) *GetProductConfigResponseProductConfigInnerCollapseTriggerConfig {
