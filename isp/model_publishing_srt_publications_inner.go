...
// checks if the PublishingSrtPublicationsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublishingSrtPublicationsInner{}
...
func NewPublishingSrtPublicationsInner() *PublishingSrtPublicationsInner {
	this := PublishingSrtPublicationsInner{}
	return &this
}

// NewPublishingSrtPublicationsInnerWithDefaults instantiates a new PublishingSrtPublicationsInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPublishingSrtPublicationsInnerWithDefaults() *PublishingSrtPublicationsInner {
	this := PublishingSrtPublicationsInner{}
	return &this
}
...
func (o *PublishingSrtPublicationsInner) HasAudioEncoders() bool {
	if o != nil && IsNil(o.AudioEncoders) {
		return true
	}
...
func (o *PublishingSrtPublicationsInner) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PublishingSrtPublicationsInner) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PublishingSrtPublicationsInner) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PublishingSrtPublicationsInner) SetId(v string) {
	o.Id = &v
}

// GetPmtPid returns the PmtPid field value if set, zero value otherwise.
func (o *PublishingSrtPublicationsInner) GetPmtPid() int32 {
...
// and a boolean to check if the value has been set.
func (o *PublishingSrtPublicationsInner) GetPmtPidOk() (*int32, bool) {
	if o == nil || IsNil(o.PmtPid) {
		return nil, false
	}
...
func (o *PublishingSrtPublicationsInner) HasPmtPid() bool {
	if o != nil && !IsNil(o.PmtPid) {
		return true
	}
...
func (o *PublishingSrtPublicationsInner) SetPmtPid(v int32) {
	o.PmtPid = &v
}

// GetScte35Pid returns the Scte35Pid field value if set, zero value otherwise.
func (o *PublishingSrtPublicationsInner) GetScte35Pid() int32 {
...
// and a boolean to check if the value has been set.
func (o *PublishingSrtPublicationsInner) GetScte35PidOk() (*int32, bool) {
	if o == nil || IsNil(o.Scte35Pid) {
		return nil, false
	}
...
func (o *PublishingSrtPublicationsInner) HasScte35Pid() bool {
	if o != nil && !IsNil(o.Scte35Pid) {
		return true
	}
...
func (o *PublishingSrtPublicationsInner) SetScte35Pid(v int32) {
	o.Scte35Pid = &v
}

// GetUrl returns the Url field value if set, zero value otherwise.
func (o *PublishingSrtPublicationsInner) GetUrl() string {
...
// and a boolean to check if the value has been set.
func (o *PublishingSrtPublicationsInner) GetUrlOk() (*string, bool) {
	if o == nil || IsNil(o.Url) {
		return nil, false
	}
	return o.Url, true
...
func (o *PublishingSrtPublicationsInner) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *PublishingSrtPublicationsInner) SetUrl(v string) {
	o.Url = &v
}
...
func (o *PublishingSrtPublicationsInner) HasVideoEncoders() bool {
	if o != nil && IsNil(o.VideoEncoders) {
		return true
	}
...
func (o PublishingSrtPublicationsInner) MarshalJSON() ([]byte, error) {
...
func (o PublishingSrtPublicationsInner) ToMap() (map[string]interface{}, error) {
...
type NullablePublishingSrtPublicationsInner struct {
	value *PublishingSrtPublicationsInner
	isSet bool
}

func (v NullablePublishingSrtPublicationsInner) Get() *PublishingSrtPublicationsInner {
	return v.value
}

func (v *NullablePublishingSrtPublicationsInner) Set(val *PublishingSrtPublicationsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePublishingSrtPublicationsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePublishingSrtPublicationsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublishingSrtPublicationsInner(val *PublishingSrtPublicationsInner) *NullablePublishingSrtPublicationsInner {
	return &NullablePublishingSrtPublicationsInner{value: val, isSet: true}
}

func (v NullablePublishingSrtPublicationsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublishingSrtPublicationsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
