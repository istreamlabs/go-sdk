...
type ChannelSignalingBlackoutSettings struct {
	...
	Slates []ChannelSignalingBlackoutSettingsSlatesInner `json:"slates,omitempty" doc:"Per-segment type slate overrides."`
}
