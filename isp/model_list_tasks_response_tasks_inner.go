...
// checks if the ListTasksResponseTasksInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasksResponseTasksInner{}
...
// NewListTasksResponseTasksInnerWithDefaults instantiates a new ListTasksResponseTasksInner object
...
type NullableListTasksResponseTasksInner struct {
	value *ListTasksResponseTasksInner
	isSet bool
}
...
func NewNullableListTasksResponseTasksInner(val *ListTasksResponseTasksInner) *NullableListTasksResponseTasksInner {
	return &NullableListTasksResponseTasksInner{value: val, isSet: true}
}
