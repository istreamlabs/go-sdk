...
type ChannelPublishingHls struct {
	...
	PartialPresentations *[]map[string]interface{} `json:"partial_presentations,omitempty"`
...
func (o *ChannelPublishingHls) GetPartialPresentations() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ChannelPublishingHls) GetPartialPresentationsOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.PartialPresentations == nil {
		return nil, false
	}
...
// SetPartialPresentations gets a reference to the given []map[string]interface{} and assigns it to the PartialPresentations field.
func (o *ChannelPublishingHls) SetPartialPresentations(v []map[string]interface{}) {
