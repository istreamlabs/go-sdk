...
func (o *Publication) GetPublishPoints() []PublicationPublishPointsInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Publication) GetPublishPointsOk() ([]PublicationPublishPointsInner, bool) {
...
func (o *Publication) SetPublishPoints(v []PublicationPublishPointsInner) {
	o.PublishPoints = v
}
