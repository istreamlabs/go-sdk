...
func Test_isp_Live2VODForOrganizationAPIService(t *testing.T) {
	...
	t.Run("Test Live2VODForOrganizationAPIService PutOrgChannelQcu", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.Live2VODForOrganizationAPI.PutOrgChannelQcu(context.Background(), org, channelId).Execute()
