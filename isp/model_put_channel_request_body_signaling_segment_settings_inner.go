...
// checks if the PutChannelRequestBodySignalingSegmentSettingsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutChannelRequestBodySignalingSegmentSettingsInner{}

// PutChannelRequestBodySignalingSegmentSettingsInner struct for PutChannelRequestBodySignalingSegmentSettingsInner
type PutChannelRequestBodySignalingSegmentSettingsInner struct {
...
// NewPutChannelRequestBodySignalingSegmentSettingsInner instantiates a new PutChannelRequestBodySignalingSegmentSettingsInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPutChannelRequestBodySignalingSegmentSettingsInner() *PutChannelRequestBodySignalingSegmentSettingsInner {
	this := PutChannelRequestBodySignalingSegmentSettingsInner{}
	return &this
}

// NewPutChannelRequestBodySignalingSegmentSettingsInnerWithDefaults instantiates a new PutChannelRequestBodySignalingSegmentSettingsInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPutChannelRequestBodySignalingSegmentSettingsInnerWithDefaults() *PutChannelRequestBodySignalingSegmentSettingsInner {
	this := PutChannelRequestBodySignalingSegmentSettingsInner{}
	return &this
}

// GetDefaultDurationSecs returns the DefaultDurationSecs field value if set, zero value otherwise.
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) GetDefaultDurationSecs() int32 {
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) GetDefaultDurationSecsOk() (*int32, bool) {
	if o == nil || IsNil(o.DefaultDurationSecs) {
		return nil, false
	}
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) HasDefaultDurationSecs() bool {
	if o != nil && !IsNil(o.DefaultDurationSecs) {
		return true
	}
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) SetDefaultDurationSecs(v int32) {
	o.DefaultDurationSecs = &v
}

// GetEmitDefaultDuration returns the EmitDefaultDuration field value if set, zero value otherwise.
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) GetEmitDefaultDuration() bool {
...
// and a boolean to check if the value has been set.
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) GetEmitDefaultDurationOk() (*bool, bool) {
	if o == nil || IsNil(o.EmitDefaultDuration) {
		return nil, false
	}
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) HasEmitDefaultDuration() bool {
	if o != nil && !IsNil(o.EmitDefaultDuration) {
		return true
	}
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) SetEmitDefaultDuration(v bool) {
	o.EmitDefaultDuration = &v
}

// GetOffsetMillis returns the OffsetMillis field value if set, zero value otherwise.
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) GetOffsetMillis() int32 {
...
// and a boolean to check if the value has been set.
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) GetOffsetMillisOk() (*int32, bool) {
	if o == nil || IsNil(o.OffsetMillis) {
		return nil, false
	}
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) HasOffsetMillis() bool {
	if o != nil && !IsNil(o.OffsetMillis) {
		return true
	}
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) SetOffsetMillis(v int32) {
	o.OffsetMillis = &v
}

// GetSegmentEndMode returns the SegmentEndMode field value if set, zero value otherwise.
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) GetSegmentEndMode() string {
...
// and a boolean to check if the value has been set.
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) GetSegmentEndModeOk() (*string, bool) {
	if o == nil || IsNil(o.SegmentEndMode) {
		return nil, false
	}
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) HasSegmentEndMode() bool {
	if o != nil && !IsNil(o.SegmentEndMode) {
		return true
	}
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) SetSegmentEndMode(v string) {
	o.SegmentEndMode = &v
}

// GetSegments returns the Segments field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) GetSegments() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) GetSegmentsOk() ([]string, bool) {
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) HasSegments() bool {
	if o != nil && IsNil(o.Segments) {
		return true
	}
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) SetSegments(v []string) {
	o.Segments = v
}

// GetTierFilter returns the TierFilter field value if set, zero value otherwise.
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) GetTierFilter() PutChannelRequestBodySignalingSegmentSettingsInnerTierFilter {
...
// and a boolean to check if the value has been set.
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) GetTierFilterOk() (*PutChannelRequestBodySignalingSegmentSettingsInnerTierFilter, bool) {
	if o == nil || IsNil(o.TierFilter) {
		return nil, false
	}
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) HasTierFilter() bool {
	if o != nil && !IsNil(o.TierFilter) {
		return true
	}
...
func (o *PutChannelRequestBodySignalingSegmentSettingsInner) SetTierFilter(v PutChannelRequestBodySignalingSegmentSettingsInnerTierFilter) {
	o.TierFilter = &v
}

func (o PutChannelRequestBodySignalingSegmentSettingsInner) MarshalJSON() ([]byte, error) {
...
func (o PutChannelRequestBodySignalingSegmentSettingsInner) ToMap() (map[string]interface{}, error) {
...
type NullablePutChannelRequestBodySignalingSegmentSettingsInner struct {
	value *PutChannelRequestBodySignalingSegmentSettingsInner
	isSet bool
}

func (v NullablePutChannelRequestBodySignalingSegmentSettingsInner) Get() *PutChannelRequestBodySignalingSegmentSettingsInner {
	return v.value
}

func (v *NullablePutChannelRequestBodySignalingSegmentSettingsInner) Set(val *PutChannelRequestBodySignalingSegmentSettingsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePutChannelRequestBodySignalingSegmentSettingsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePutChannelRequestBodySignalingSegmentSettingsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutChannelRequestBodySignalingSegmentSettingsInner(val *PutChannelRequestBodySignalingSegmentSettingsInner) *NullablePutChannelRequestBodySignalingSegmentSettingsInner {
	return &NullablePutChannelRequestBodySignalingSegmentSettingsInner{value: val, isSet: true}
}

func (v NullablePutChannelRequestBodySignalingSegmentSettingsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutChannelRequestBodySignalingSegmentSettingsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
