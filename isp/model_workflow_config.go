...
type WorkflowConfig struct {
	CutprogramPaddingInSeconds interface{} `json:"cutprogram_padding_in_seconds,omitempty" format:"int64"`
	MakeMp4 interface{} `json:"make_mp4,omitempty"`
	Mp4FeatureFlag interface{} `json:"mp4-feature-flag,omitempty"`
}
...
// GetCutprogramPaddingInSeconds returns the CutprogramPaddingInSeconds field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WorkflowConfig) GetCutprogramPaddingInSeconds() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *WorkflowConfig) GetCutprogramPaddingInSecondsOk() (*interface{}, bool) {
...
// SetCutprogramPaddingInSeconds gets a reference to the given interface{} and assigns it to the CutprogramPaddingInSeconds field.
func (o *WorkflowConfig) SetCutprogramPaddingInSeconds(v interface{}) {
	o.CutprogramPaddingInSeconds = v
}

// GetMakeMp4 returns the MakeMp4 field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WorkflowConfig) GetMakeMp4() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WorkflowConfig) GetMakeMp4Ok() (*interface{}, bool) {
...
// SetMakeMp4 gets a reference to the given interface{} and assigns it to the MakeMp4 field.
func (o *WorkflowConfig) SetMakeMp4(v interface{}) {
	o.MakeMp4 = v
}

// GetMp4FeatureFlag returns the Mp4FeatureFlag field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WorkflowConfig) GetMp4FeatureFlag() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WorkflowConfig) GetMp4FeatureFlagOk() (*interface{}, bool) {
...
// SetMp4FeatureFlag gets a reference to the given interface{} and assigns it to the Mp4FeatureFlag field.
func (o *WorkflowConfig) SetMp4FeatureFlag(v interface{}) {
	o.Mp4FeatureFlag = v
}
